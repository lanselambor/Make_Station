...
void TM1637::display(int8_t DispData[],uint8_t DispFlag)
{
  int8_t SegData[4];
  uint8_t i;
...
//******************************************
void TM1637::display(uint8_t BitAddr,int8_t DispData,uint8_t DispFlag)
{
  int8_t SegData;
...
void TM1637::coding(int8_t DispData[],uint8_t DispFlag)
{
  uint8_t PointData;
  if(DispFlag == DISPLAY_FLAG_F)
  {
...
int8_t TM1637::coding(int8_t DispData,uint8_t DispFlag)
{
  uint8_t PointData;
  if(DispFlag == DISPLAY_FLAG_F)
  {
